...
class SecondyearScreen extends StatefulWidget {
  const SecondyearScreen({Key? key}) : super(key: key);

  @override
  State<SecondyearScreen> createState() => _SecondyearScreenState();
}
...
class _SecondyearScreenState extends State<SecondyearScreen> {
    ...
    return Visibility(
      ...
      child: (
        AnimatedContainer(
          ...
          color: Color.fromRGBO(117, 126, 255, 0.3),
